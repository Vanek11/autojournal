...
const filePath = path.join(root, "src/app/app/billing/page.tsx");
const backupPath = path.join(root, ".backup-billing-page.tsx");

if (fs.existsSync(filePath)) {
  fs.copyFileSync(filePath, backupPath);
  console.log("backup created: .backup-billing-page.tsx");
}
...
console.log("updated: src/app/app/billing/page.tsx");
console.log("Billing page fixed.");